  ...
  AMapLoader.load({
    ...
    plugins: [
      ...
      .then((AMap) => {
        ...
        let arrs2 = [
          ['青铁芳华地', '李沧区松乐汀商业广场', '#b6a014'],
          ['卓越皇后道千山外', '李沧区松乐汀商业广场', '#80a492'],
          ['新城香溢紫郡二期', '李沧区松乐汀商业广场', '#8b7042'],
          ['卓越皇后道', '李沧区松乐汀商业广场', '#f3a694'],
          ['新城香溢紫郡一期', '李沧区松乐汀商业广场', '#f9d3e3'],
          ['和达璟城', '李沧区松乐汀商业广场', '#beb1aa'],
          ['上流和苑', '李沧区松乐汀商业广场', '#e5a84b'],
          ['海尔博悦兰庭', '李沧区松乐汀商业广场', '#c0d695'],
          ['万科生态城熙景', '李沧区松乐汀商业广场', '#ba5b49'],
          ['万科生态城观澜', '李沧区松乐汀商业广场', '#f6bec8'],
          ['万科如园', '李沧区松乐汀商业广场', '#9aa7b1'],
          ['和达和城', '李沧区松乐汀商业广场', '#d2af9d'],
        ]
        let arrs3 = [
          ['青铁芳华地', '青岛市第八人民医院(东院区)', '#b6a014'],
          ['卓越皇后道千山外', '青岛市第八人民医院(东院区)', '#80a492'],
          ['新城香溢紫郡二期', '青岛市第八人民医院(东院区)', '#8b7042'],
          ['卓越皇后道', '青岛市第八人民医院(东院区)', '#f3a694'],
          ['新城香溢紫郡一期', '青岛市第八人民医院(东院区)', '#f9d3e3'],
          ['和达璟城', '青岛市第八人民医院(东院区)', '#beb1aa'],
          ['上流和苑', '青岛市第八人民医院(东院区)', '#e5a84b'],
          ['海尔博悦兰庭', '青岛市第八人民医院(东院区)', '#c0d695'],
          ['万科生态城熙景', '青岛市第八人民医院(东院区)', '#ba5b49'],
          ['万科生态城观澜', '青岛市第八人民医院(东院区)', '#f6bec8'],
          ['万科如园', '青岛市第八人民医院(东院区)', '#9aa7b1'],
          ['和达和城', '青岛市第八人民医院(东院区)', '#d2af9d'],
        ]
